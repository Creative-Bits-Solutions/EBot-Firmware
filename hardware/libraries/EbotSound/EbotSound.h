#ifndef _EBOT_SOUND_H
#define _EBOT_SOUND_H
/*
 * Ebot Sound
 * Version 0.1 September, 2017
 * Reference:  This list was adapted from the table located here:
 * http://www.phy.mtu.edu/~suits/notefreqs.html * Edited by Mitra to add new controller SANYO
 * Credits : Otto DIY
 * Edited by Sanukrishnan @ CreativeBits. www.cbits.cc
 */
