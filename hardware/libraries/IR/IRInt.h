...
#include <Arduino.h> // deleted WProgram.h and left arduino.h by default, Hesham Mahmoud 13.6.2014
...
// Sanguino / Erobot 
 ...
 #define IR_USE_TIMER2     // tx = pin 14
  //#define IR_USE_TIMER3     // tx = 2 pin  ( erobot )
...
#elif defined(__AVR_ATmega644P__) || defined(__AVR_ATmega644__) || defined(__AVR_ATmega1284P__) || defined(__AVR_ATmega1284__)
#define TIMER_PWM_PIN        2 /* Sanguino */
#else
